...
class AddPdfBook extends StatefulWidget {
  @override
  _AddPdfBookState createState() => _AddPdfBookState();
}

class _AddPdfBookState extends State<AddPdfBook> {
...
Future getPdfAndUpload() async {
  ...
  void _addCategory() async {
    if (nameController.text.isEmpty) {
      return _showMsg("Pdf book Name is empty");
    } else if (_cover=="") {
    ...
    var res = await CallApi().postData(data, '/api/addPdfBook');
...
//  id: 6}
      ...
      if (res.statusCode == 200) {
        store.state.pdfBookList.add(
          {
            "id": body['data']['id'],
            "pdfName": body['data']['pdfName'],
            "pdfImage": body['data']['pdfImage'],
          }
        );
