...
import 'package:Easy_shopping_admin/SearchProduct/SearchProduct.dart';
...
class _AllProductsState extends State<AllProducts> {
  ...
  String search = "";
  String result = '', maxPrice = "", minPrice = "", cat = "", catName = "", orderName = "", nameOrder = "", orderType = "", typeOrder = "";
  var catList, user;
  // List filterList=[
  //   {
  ...
  //       '/api/searchProduct/${searchController.text}');
  //   body = json.decode(res.body);

  //   print(body);

  //   if (res.statusCode == 200) {
  //    // filterList = body['Product'];
  //     store.dispatch(ProductListAction(body['Product']));
  //    // _getFilterlist();
  //   }
        ...
        child: StoreConnector<AppState, AppState>(
            ...
            builder: (context, items) {
              return Scaffold(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      Navigator.push(context, SlideLeftRoute(page: SearchProduct()));
                                      // if (isSearch == false) {
                                      //   isSearch = true;
                                      // } else {
                                      //   isSearch = false;
                                  ...
                                  child: Container(
                                      ...
                                      child: Icon(isSearch == true ? Icons.close : Icons.search, color: Colors.white)),
                                ),
                              ],
                            ),
                          ),
                  ...
                  body: SafeArea(
                    child: store.state.productLoading
                        ? Center(
                            ...
                            : RefreshIndicator(
                                ...
                                child: Container(
                                    ...
                                    child: Stack(
                                      children: <Widget>[
                                        Container(
                                            margin: EdgeInsets.only(top: isFilter == false ? 0 : 60),
